...
"#include <gerbil.h>" <humble@HUMBLE.GERBIL.COM> writes:

[roto router]

Here's one I wrote a couple of years back for personal use.
...
populate_hops(char *fn)
{
        ...
        fprintf(stderr, "%d fakeroute rules loaded\n", rules);
}
